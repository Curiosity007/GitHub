...
#EPEL repo for syslog-ng
rpm -Uvh http://freevps.us/downloads/epel-release-6-6.noarch.rpm

################################
# Install PHP, NGINX and MySQL #
################################

yum -y install mysql-server php-fpm php-mysql php-gd nginx nano exim syslog-ng cronie
